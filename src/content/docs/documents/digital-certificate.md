...
ACCV (Agencia de Certificación Electrónica de la Comunitat Valenciana) – центр электронной сертификации Валенсийского сообщества. Позволяет получить сертификат **полностью онлайн за 1 день** через видеоидентификацию.

**Требования:**
- TIE (NIE) или разрешение на проживание
- Устройство с камерой
- Испанский номер телефона

**Преимущества:**
- Не требуется личный визит в офис
- Сертификат готов за 1-2 часа (при подаче в первой половине дня)
- Бесплатно
...
- Показать документ (TIE/NIE) с обеих сторон
- Сделать селфи
- Выполнить действия по инструкции (посмотреть направо/налево, улыбнуться)
- Ввести код из СМС

Проверка обычно занимает 1-2 часа в рабочее время.
