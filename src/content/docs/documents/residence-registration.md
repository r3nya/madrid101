...
- [Записаться на прием для оформления прописки](https://www.madrid.es/citaprevia) (можно в любом районе)
...
2. **Документ, подтверждающий право проживания в жилье**:
    ...
    - Если вы арендатор: договор аренды (contrato de alquiler) сроком не менее 6 месяцев с указанием referencia catastral; либо *declaración responsable*
...
1. Запишитесь на прием [в любой офис муниципалитета через madrid.es/citaprevia](https://www.madrid.es/citaprevia).
...
С использованием Cl@ve, DNIe или [цифрового сертификата](/documents/digital-certificate/) можно [оформить прописку онлайн](https://servpub.madrid.es/sta/CarpetaPrivate/doEvent?APP_CODE=STA&PAGE_CODE=PADRON_ALTA) без необходимости посещения офиса муниципалитета.

:::caution
Для граждан стран, не входящих в ЕС, нужна *renovación* прописки каждые 2 года. Для граждан ЕС — *confirmación* (подтверждение) каждые 5 лет.
:::
