...
- Distintivo **CERO**: бонификация **75%** бессрочно
- Distintivo **ECO**: бонификация **75%** в течение **6 лет** с первой matriculación
...
Можно настроить автоматическое списание (domiciliación) налога с банковского счёта. Для этого зарегистрируйте счёт на [сайте мэрии Мадрида](https://sede.madrid.es/portal/site/tramites).

Domiciliación удобна (списание в конце периода добровольной оплаты), но **скидки за неё по IVTM нет** — бонус 1% бывает у других налогов (например, IBI), не у налога на автомобиль.
